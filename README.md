...
to create isolated Haskell environments. This is
the clone of [tmhedberg/hsenv](https://github.com/tmhedberg/hsenv)
...
hsenv has been tested on Linux, Mac OS X, FreeBSD, and MSYS(1&2) systems, but it should
